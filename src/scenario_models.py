...
class NeueTaetigkeitMitFznSchritt(BaseModel):
    ...
    def generate_entries(self, ctx: FunkContext) -> List[FunkEntry]:
        ...
        e: List[FunkEntry] = [
            ...
            FunkEntry(actor="FZ", message=f"Hier Melder {ctx.fk}, kommen."),
            FunkEntry(actor="SF",
                      message=f"Wir haben eine neue Tätigkeit mit Fahrzeugnennung in der {self.adresse} {self.ortsteil}, {self.ereignis}, kommen."),
            FunkEntry(actor="FZ",
                      message=f"Verstanden, neue Tätigkeit mit Fahrzeugnennung in der {self.adresse} {self.ortsteil}, {self.ereignis}, kommen."),
            FunkEntry(actor="SF", message="So richtig, Ende."),
...
class NeueTaetigkeitMitFznStatus1Schritt(BaseModel):
    ...
    def generate_entries(self, ctx: FunkContext) -> List[FunkEntry]:
        ...
        return [
            ...
            FunkEntry(actor="FZ", message=f"Hier Melder {ctx.fk}, kommen."),
            FunkEntry(actor="SF",
                      message=f"Eigenmeldung mit Fahrzeugnennung in der {self.adresse} {self.ortsteil}, {self.ereignis}, kommen."),
            FunkEntry(actor="FZ",
                      message=f"Verstanden, Eigenmeldung mit Fahrzeugnennung in der {self.adresse} {self.ortsteil}, {self.ereignis}, kommen."),
            FunkEntry(actor="SF", message="So richtig, Ende."),
            FunkEntry(actor="FZ", status="3"),
            FunkEntry(actor="FZ", status="0" if self.sonderrechte else "5"),
            FunkEntry(actor="LS", message=f"Florian {ctx.fk} Sprechwunsch, kommen."),
...
class NeueTaetigkeitOhneFznSchritt(BaseModel):
    ...
    def generate_entries(self, ctx: FunkContext) -> List[FunkEntry]:
        return [
            ...
            FunkEntry(actor="FZ", message=f"Hier Melder {ctx.fk}, kommen."),
            FunkEntry(actor="SF",
                      message=f"Eigenmeldung ohne Fahrzeugnennung in der {self.adresse} {self.ortsteil}, {self.ereignis}, kommen."),
            FunkEntry(actor="FZ",
                      message=f"Verstanden, Eigenmeldung ohne Fahrzeugnennung in der {self.adresse} {self.ortsteil}, {self.ereignis}, kommen."),
            FunkEntry(actor="SF", message="So richtig, Ende."),
            FunkEntry(actor="FZ", status="0"),
            FunkEntry(actor="LS", message=f"Florian {ctx.fk} Sprechwunsch, kommen."),
...
class Einsatz(BaseModel):
    ...
    def generate_alarmierung(self, ctx: FunkContext) -> List[FunkEntry]:
        ...
        return [
            ...
            FunkEntry(actor="SF", message=f"Hier Staffelführer {ctx.fk}, kommen."),
            FunkEntry(actor="FZ",
                      message=f"Neuer Alarm, {self.stichwort} in der {self.adresse} in {self.ortsteil}{zusatz}, Quittung kommen."),
            FunkEntry(actor="SF",
                      message=f"Neuer Alarm, {self.stichwort} in der {self.adresse} in {self.ortsteil}{zusatz}, kommen."),
            FunkEntry(actor="FZ", message="So richtig, Ende."),
        ]
